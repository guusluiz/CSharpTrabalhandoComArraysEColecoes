        ...
        private List<ContaCorrente> _listaDeContas = new List<ContaCorrente>()
{
    ...
    new ContaCorrente(94, "987321-W"){Saldo=60,Titular = new Cliente{Cpf="33333",Nome ="Marisa"}}
        ...
        private void PesquisarContas()
        {
            ...
            Console.WriteLine("===============================");
            Console.WriteLine("\n");
            Console.Write("Deseja pesquisar por (1) NÚMERO DA CONTA ou (2) CPF TITULAR ou (3) NÚMERO DA AGÊNCIA? ");
            switch (int.Parse(Console.ReadLine()))
            {
                case 1:
                    {
                        ...
                        ContaCorrente consultaConta = CosultaPorNumeroConta(_numeroConta);
                ...
                default:
                    Console.WriteLine("Opão não implementada.");
                    break;
            }
        }
        ...
        private ContaCorrente CosultaPorNumeroConta(string? numeroConta)
        {
            return _listaDeContas.Where(conta => conta.Titular.Nome == numeroConta).FirstOrDefault();
        }
